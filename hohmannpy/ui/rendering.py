...
class RenderEngine:
    r"""
    Base class for rendering simulations generated by :class:`~hohmannpy.astro.Mission`. Uses pygfx to generate navigable 3D scenes
...
class DynamicRenderEngine(RenderEngine):
    ...
    def animate(self):
        r"""
        See :class:`~hohmannpy.ui.RenderEngine` . :meth:`~hohmannpy.ui.RenderEngine.animate()`. This simply adds in :attr:`sim_time` marching as well as rotating the
        Earth and moving the satellite.
        """
